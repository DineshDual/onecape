      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          {services.filter(s => s.featured).map((service) => (
            <div
              key={service.id}
              className="group accent-border-hover lg:col-span-2 lg:row-span-2 glass-card p-8 sm:p-10 lg:p-12 transition-all duration-500 hover:translate-y-[-4px] rounded-lg relative overflow-hidden"
            >
              {/* Background accent */}
          ...
          {services.filter(s => !s.featured).map((service) => (
            <div
              key={service.id}
              className="group accent-border-hover glass-card p-8 transition-all duration-500 hover:translate-y-[-4px] rounded-lg relative overflow-hidden"
            >
              <div className="relative">
