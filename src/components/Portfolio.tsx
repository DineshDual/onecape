      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {capabilities.map((cap) => (
            <div
              key={cap.title}
              className="group accent-border-hover glass-card p-8 transition-all duration-500 hover:translate-y-[-4px] rounded-lg"
            >
              <div className="p-3 bg-[#FF6600]/10 rounded-lg text-[#FF6600] mb-6 transition-all duration-300 group-hover:bg-[#FF6600]/20 group-hover:scale-105 inline-block">
                {cap.icon}
              </div>
        ...
        <div className="mt-12 text-center">
          <a
            href="#contact"
            className="inline-flex items-center gap-2 text-[#FF6600] font-bold hover:gap-3 transition-all duration-300 text-lg"
          >
